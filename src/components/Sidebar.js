...
const Sidebar = () => {
  ...
  const adminLinks = [
    ...
    { path: '/admin/invoices', label: 'All Invoices', icon: 'invoices' },
  ...
  const getIcon = (iconName) => {
    switch (iconName) {
      ...
      case 'payments':
        return (
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
        );
      default:
        return null;
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`bg-gray-800 text-white h-screen w-64 fixed left-0 top-0 overflow-y-auto z-50 transform transition-transform duration-300 ease-in-out ${
