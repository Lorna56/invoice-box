...
const Settings = () => {
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      console.log('Sending update request with data:', { name, email });
      ...
      if (response.data.user) {
        ...
        // If backend doesn't return user data, create updated user object from form data
        const updatedUser = {
          ...user,
          name: name,
          email: email
        };
        console.log('Updating user context with form data:', updatedUser);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full space-y-8">
        <div>
          <h1 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Settings</h1>
        ...
        {!deleteSuccess ? (
          ...
          <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
            <div className="text-center">
              ...
              <h3 className="text-lg leading-6 font-medium text-gray-900">Account Deleted Successfully</h3>
              <p className="mt-2 text-sm text-gray-500">
                Your account has been permanently deleted. You will be redirected to the home page in {countdown} seconds.
              </p>
              <div className="mt-6">
                <button
                  type="button"
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md mx-auto">
            ...
            <h3 className="text-lg leading-6 font-medium text-gray-900 text-center mb-2">Delete Account</h3>
            <p className="text-sm text-gray-500 text-center mb-4">
              Are you sure you want to delete your account? This action is irreversible and will permanently delete all your data, including invoices and payment history.
            </p>
