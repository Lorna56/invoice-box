      ...
      <div className="max-w-6xl w-full space-y-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">View and export all payment records in the system.</p>
          </div>
          <ExportPayment payments={payments} />
        </div>
        <div id="payment-table-content" className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {payments.map((payment) => (
                <tr key={payment._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{payment.invoice.provider.name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{payment.invoice.purchaser.name}</td>
